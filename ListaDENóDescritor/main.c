...
int main()
{
    ...
    while (1) {
        printf("\n 1) Criar a lista dinamica encadeada com descritor");
        printf("\n 2) Liberar  lista dinamica encadeada com descritor");
        printf("\n 3) Inserir no inicio");
        printf("\n 4) Inserir no fim");
        ...
        printf("\n 11) Imprimir lista dinamica encadeada com descritor");
        printf("\n 12) Sair");
        printf("\n\nOpcao: ");
        scanf("%d", &entrada);
